...
namespace PlantaPiloto.Services {
    ...
    public partial class DataSet1 : global::System.Data.DataSet {
        ...
        public partial class datosDataTable : global::System.Data.TypedTableBase<datosRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public datosRow AdddatosRow(int Id, string Time, string Nombre, double Numero) {
        ...
        public partial class datosRow : global::System.Data.DataRow {
            ...
            public string Time {
                get {
                    return ((string)(this[this.tabledatos.TimeColumn]));
                }
                set {
                    this[this.tabledatos.TimeColumn] = value;
                }
            }
            ...
            public double Numero {
                get {
                    try {
                        return ((double)(this[this.tabledatos.NumeroColumn]));
                    }
                    catch (global::System.InvalidCastException e) {
                        throw new global::System.Data.StrongTypingException("El valor de la columna \'Numero\' de la tabla \'datos\' es DBNull.", e);
                    }
                }
                set {
...
namespace PlantaPiloto.Services.DataSet1TableAdapters {
    ...
    public partial class datosTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[datos] WHERE (([Id] = @Original_Id) AND ([Time] = @Original_Ti" +
                "me) AND ((@IsNull_Nombre = 1 AND [Nombre] IS NULL) OR ([Nombre] = @Original_Nomb" +
                "re)) AND ((@IsNull_Numero = 1 AND [Numero] IS NULL) OR ([Numero] = @Original_Num" +
                "ero)))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[datos] ([Id], [Time], [Nombre], [Numero]) VALUES (@Id, @Time, " +
                "@Nombre, @Numero);\r\nSELECT Id, Time, Nombre, Numero FROM datos WHERE (Id = @Id)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[datos] SET [Id] = @Id, [Time] = @Time, [Nombre] = @Nombre, [Numero] = @Numero WHERE (([Id] = @Original_Id) AND ([Time] = @Original_Time) AND ((@IsNull_Nombre = 1 AND [Nombre] IS NULL) OR ([Nombre] = @Original_Nombre)) AND ((@IsNull_Numero = 1 AND [Numero] IS NULL) OR ([Numero] = @Original_Numero)));
SELECT Id, Time, Nombre, Numero FROM datos WHERE (Id = @Id)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::PlantaPiloto.Properties.Settings.Default.DBplantaConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Id, Time, Nombre, Numero FROM dbo.datos";
        ...
        public virtual int Delete(int Original_Id, string Original_Time, string Original_Nombre, global::System.Nullable<double> Original_Numero) {
            ...
            if ((Original_Numero.HasValue == true)) {
                ...
                this.Adapter.DeleteCommand.Parameters[5].Value = ((double)(Original_Numero.Value));
            }
            else {
        ...
        public virtual int Insert(int Id, string Time, string Nombre, global::System.Nullable<double> Numero) {
            ...
            if ((Numero.HasValue == true)) {
                this.Adapter.InsertCommand.Parameters[3].Value = ((double)(Numero.Value));
            }
            else {
        ...
        public virtual int Update(int Id, string Time, string Nombre, global::System.Nullable<double> Numero, int Original_Id, string Original_Time, string Original_Nombre, global::System.Nullable<double> Original_Numero) {
            ...
            if ((Numero.HasValue == true)) {
                this.Adapter.UpdateCommand.Parameters[3].Value = ((double)(Numero.Value));
            }
            else {
            ...
            if ((Original_Numero.HasValue == true)) {
                ...
                this.Adapter.UpdateCommand.Parameters[9].Value = ((double)(Original_Numero.Value));
            }
            else {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string Time, string Nombre, global::System.Nullable<double> Numero, int Original_Id, string Original_Time, string Original_Nombre, global::System.Nullable<double> Original_Numero) {
            return this.Update(Original_Id, Time, Nombre, Numero, Original_Id, Original_Time, Original_Nombre, Original_Numero);
        }
    }
