...
\noindent Dr. Daniel Sarabia Ortiz, profesor del departamento de Ingeniería Electromecánica, área de Ingeniería de Sistemas y Automática, y Dr. Alejandro Merino Gómez, profesor del departamento de Ingeniería Electromecánica, área de Ingeniería de Sistemas y Automática.
...
\begin{abstract}
Interfaz hombre-máquina, monitorización, NXP, Freescale, FRDMK64F, .NET, Windows Forms, C\#, SCADA.
\end{abstract}
...
\begin{abstract}
Man machine interface, monitoring, NXP, Freescale, FRDMK64F, .NET, Windows Forms, C\#, SCADA.
\end{abstract}
