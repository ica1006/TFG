...
\begin{abstract}
Interfaz hombre-máquina, monitorización, NXP, Freescale, FRDMK64F, .NET, Windows Forms\ldots
\end{abstract}
...
\begin{abstract}
Man machine interface, monitoring, NXP, Freescale, FRDMK64F, .NET, Windows Forms.
\end{abstract}
