...
\begin{abstract}
Interfaz hombre-máquina, monitorización, NXP, Freescale, FRDMK64F, .NET, Windows Forms, C$\sharp$\ldots
\end{abstract}
...
\begin{abstract}
Man machine interface, monitoring, NXP, Freescale, FRDMK64F, .NET, Windows Forms, C$\sharp$\ldots
\end{abstract}
